...
abstract class BaseSharedFileBitSetFactoryImplTest {

  protected static final String BASE_FILENAME = "./shardedQueueTest.bit";
  protected static final int SHARD_COUNT = 4;
  protected static final int WINDOW_SIZE = 128;
  protected static final int SESSION_COUNT = 20;
  protected static final int TOTAL_EVENTS = 2000;

  protected abstract SharedFileBitSetFactoryImpl buildFactory() throws IOException;
